  ...
  return (
    <section className="bg-[#060911] py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Featured card */}
        <a
          href={`/classes/${featured.slug.current}`}
          className="group relative block rounded-3xl overflow-hidden mb-4 bg-[#10141f] border border-white/5 hover:border-[#8c7df8]/30 transition-all duration-300"
        >
          {featured.image ? (
            <div className="aspect-[16/7] overflow-hidden">
              <img
                src={urlFor(featured.image).width(1200).height(525).auto('format').quality(80).url()}
                alt={featured.title}
            ...
            <div className="aspect-[16/7] bg-gradient-to-br from-[#8c7df8]/10 to-transparent" />
          )}
          <div className="absolute bottom-0 left-0 p-8 md:p-10">
            <span className="mb-3 inline-block rounded-full bg-[#8c7df8]/20 border border-[#8c7df8]/30 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-[#bab1fa]">
              Uitgelicht
            </span>
            <h3 className="text-3xl md:text-4xl font-black text-white mb-2">{featured.title}</h3>
            {featured.description && (
              <div className="text-sm text-white/60 max-w-lg line-clamp-2">
            ...
            {rest.map((service) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {service.description && (
                    <div className="text-sm text-[#8b94a8] leading-relaxed line-clamp-2">
